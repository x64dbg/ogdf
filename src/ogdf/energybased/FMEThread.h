...
{
public:
    AutoLock(CriticalSection* cs) : m_pCriticalSection(cs)
    {
...
public:
    ...
    inline __uint32 threadNr() const
    {
        return m_threadNr;
    }

    //! returns the total number of threads in the pool
    inline __uint32 numThreads() const
    {
        return m_numThreads;
    }
    ...
    inline FMEThreadPool* threadPool() const
    {
...
public:
    ...
    inline FMEThread* thread(__uint32 threadNr) const
    {
        return m_pThreads[threadNr];
    }

    //! returns the barrier instance used to sync the threads during execution
    inline Barrier* syncBarrier() const
    {
        return m_pSyncBarrier;
    }
