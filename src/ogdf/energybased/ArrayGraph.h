...
namespace ogdf
{
    ...
    public:
         ...
         */
        inline __uint32 numNodes() const
        {
            return m_numNodes;
        }
         ...
         * \return the number of nodes
         */
        inline __uint32 numEdges() const
        {
            return m_numEdges;
        }
        ...
        inline NodeAdjInfo & nodeInfo(__uint32 i)
        {
            return m_nodeAdj[i];
        }

        //! returns the adjacency information for a node
        inline const NodeAdjInfo & nodeInfo(__uint32 i) const
        {
            return m_nodeAdj[i];
        }

        //! returns the adjacency information for an edge
        inline EdgeAdjInfo & edgeInfo(__uint32 i)
        {
            return m_edgeAdj[i];
        }

        //! returns the adjacency information for an edge
        inline const EdgeAdjInfo & edgeInfo(__uint32 i) const
        {
            return m_edgeAdj[i];
        }
         ...
         * The array is 16 byte aligned
         */
        inline const NodeAdjInfo* nodeInfo() const
        {
            return m_nodeAdj;
        }
         ...
         * The array is 16 byte aligned
         */
        inline const EdgeAdjInfo* edgeInfo() const
        {
            return m_edgeAdj;
        }
         ...
         * The array is 16 byte aligned
         */
        inline const float* nodeXPos() const
        {
            return m_nodeXPos;
        }
         ...
         * The array is 16 byte aligned
         */
        inline const float* nodeYPos() const
        {
            return m_nodeYPos;
        }
         ...
         * The array is 16 byte aligned
         */
        inline float* nodeMoveRadius()
        {
            return m_nodeMoveRadius;
        }
         ...
         * The array is 16 byte aligned
         */
        inline const float* nodeSize() const
        {
            return m_nodeSize;
        }
         ...
         * The array is 16 byte aligned
         */
        inline float* desiredEdgeLength()
        {
            return m_desiredEdgeLength;
        }
         ...
         * The array is 16 byte aligned
         */
        inline const float* desiredEdgeLength() const
        {
            return m_desiredEdgeLength;
        }
        ...
        inline float avgDesiredEdgeLength() const
        {
            return (float)m_desiredAvgEdgeLength;
        }

        inline float avgNodeSize() const
        {
            return (float)m_avgNodeSize;
        }
