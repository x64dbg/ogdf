...
namespace ogdf
{
    ...
    public:
        ...
        __uint32 sizeInBytes() const
        {
            return m_numExp * m_numCoeff * (__uint32)sizeof(double) * 4;
        }

        //! returns the array with multipole coefficients
        inline double* multiExp() const
        {
            return m_multiExp;
        }

        //! returns the array with local coefficients
        inline double* localExp() const
        {
            return m_localExp;
        }

        //! number of coefficients per expansions
        inline __uint32 numCoeff() const
        {
            return m_numCoeff;
        }
