...
namespace ogdf
{
    ...
    public:
        ...
        {
            return Ogml::s_attributeValueNames[id];
        }
    ...
    */
    ...
    public:
        ...
        {
            return Ogml::s_attributeNames[id];
        }
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            while(segIt.valid() && !inserted)
                                                            {
                                                                        ...
                                                                        (actSeg.point2 == (*segIt).point2))
                                                                {
                                                                    ...
                                                                    else if(actSeg.point2 == (*segIt).point1)
                                                                    {
                                                                        segments.insertBefore(actSeg, segIt);
                                                                    }
                                                                    else if((actSeg.point2 == (*segIt).point2))
                                                                    {
                                                                        DPoint dumP = actSeg.point1;
                                                                        actSeg.point1 = actSeg.point2;
                                                                        actSeg.point2 = dumP;
