...
namespace ogdf
{
    ...
    private:
        ...
        bool transpose()
        {
            return m_sugi.transpose();
        }

        bool arrangeCCs() const
        {
            return m_sugi.arrangeCCs();
        }
        int arrange_numCC() const
        {
            return m_sugi.numCC();
        }
        const NodeArray<int> & arrange_compGC() const
        {
            return m_sugi.compGC();
        }
