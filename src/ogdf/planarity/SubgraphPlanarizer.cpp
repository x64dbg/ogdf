...
public:
    ...
    const EdgeArray<bool> *forbid() const
    {
        return m_pForbid;
    }
    const EdgeArray<__uint32> *edgeSubGraphs() const
    {
        return m_pEdgeSubGraph;
    }
    const List<edge> &delEdges() const
    {
        return m_delEdges;
    }

    int rseed(long id) const
    {
        return (int)id * m_seed;
    }

    int queryBestKnown() const
    {
        return m_bestCR;
    }
