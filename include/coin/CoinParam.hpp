...
public:
    ...
    */
    ...
    inline void setShortHelp(const std::string help)
    {
        shortHelp_ = help ;
    }
    ...
    */
    ...
    inline CoinParamType type() const
    {
        return (type_) ;
    }
    ...
    inline void setType(CoinParamType type)
    {
        type_ = type ;
    }
    ...
    */
    ...
    inline void setPushFunc(CoinParamFunc func)
    {
        pushFunc_ = func ;
    }
    ...
    inline void setPullFunc(CoinParamFunc func)
    {
        pullFunc_ = func ;
    }
