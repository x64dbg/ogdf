...
public:
    ...
    */
    ...
    inline void   setVar(const int v)
    {
        varInd_ = v;
    }
    inline void   setVal(const double v)
    {
        upper_ = v;
    }
    //@}
...
public:
    ...
    */
    ...
    /**@name Functions to query and set maximum number of cuts can be
       generated. */
    //@{
    inline int getMaxNumCuts() const
    {
        return maxNumCuts_;
    }
    inline void setMaxNumCuts(int mc)
    {
        maxNumCuts_ = mc;
    }
    //@}
...
private:
    ...
    */
    ...
    //@{
    inline const CglFlowVUB* getVubs() const
    {
        return vubs_;
    }
    ...
    //@{
    inline const CglFlowVLB* getVlbs() const
    {
        return vlbs_;
    }
