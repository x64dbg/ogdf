...
public:
    ...
    inline int          getFractionality() const
    {
        return fractionality_;
    }
    inline double       getQuality()       const
    {
        return quality_;
    }
    inline double       getTrueLB()        const
    {
        return true_lower_bound_;
    }
    inline BitVector128 getPreferred()     const
    {
        return preferred_;
    }
    ...
    inline void setFractionality(int f)
    {
        fractionality_ = f;
    }
    inline void setQuality(double q)
    {
        quality_ = q;
    }
    inline void setTrueLB(double tlb)
    {
        true_lower_bound_ = tlb;
    }
    inline void setPreferred(BitVector128 p)
    {
        preferred_ = p;
    }
};
...
public:
    ...
    inline CoinTreeNode* currentNode() const
    {
        return siblings_[current_];
    }
    /** returns false if cannot be advanced */
    inline bool advanceNode()
    {
        return ++current_ != numSiblings_;
    }
    inline int toProcess() const
    {
...
public:
    ...
    inline size_t numInserted() const
    {
        return candidates_->numInserted();
    }
    inline CoinTreeNode* top() const
    {
