...
public:
    ...
    inline double getEPS_RELAX_ABS() const
    {
        return EPS_RELAX_ABS;
    }

    /** Set EPS_RELAX_REL */
    virtual void setEPS_RELAX_REL(const double eps_rr);
    /** Get value of EPS_RELAX_REL */
    inline double getEPS_RELAX_REL() const
    {
        return EPS_RELAX_REL;
    }
    ...
    inline double getMAXDYN_LUB() const
    {
        return MAXDYN_LUB;
    }
    ...
    inline double getEPS_COEFF_LUB() const
    {
    ...
    inline double getMINVIOL() const
    {
        return MINVIOL;
    }
    ...
    inline int getUSE_INTSLACKS() const
    {
    ...
    inline double getNormIsZero() const
    {
        return normIsZero;
    }
    ...
    inline double getMinReduc() const
    {
        return minReduc;
    }
